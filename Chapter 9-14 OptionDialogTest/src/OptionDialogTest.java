...
class OptionDialogFrame extends JFrame {
	...
	public OptionDialogFrame() {
		...
		messageTypePanel = new ButtonPanel("Message Type", "ERROR_MESSAGE", "INFORMATION_MESSAGE", "WARNING MESSAGE", "QUESTION_MESSAGE", "PLAIN_MESSAGE");
	 ...
	 * @ returns a string, icon, component, or object array depending on the Message panel selection
	 */
	...
	public Object[] getOptions() {
		...
		else if (s.equals("Icon[]")) return new Icon[] { new ImageIcon("yellow-ball.gif"), new ImageIcon("blue-ball.gif"),
	...
	private class ShowAction implements ActionListener {
		...
		public void actionPerformed(ActionEvent event) {
			...
			if (typePanel.getSelection().equals("Confirm")) JOptionPane.showConfirmDialog(OptionDialogFrame.this
